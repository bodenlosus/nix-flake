...
in
{
  ...
  programs.hyprpanel = {
    ...
    override = {
      ...
      "theme.bar.buttons.padding_y" = "0.35rem";
      "theme.bar.buttons.workspaces.hover" = "${accent-alt}";
      "theme.bar.buttons.workspaces.active" = "${accent}";
      "theme.bar.buttons.workspaces.available" = "${accent-alt}";
      "theme.bar.buttons.workspaces.occupied" = "${accent-alt}";
      "theme.bar.buttons.background_opacity" = opacity * 100;
      ...
      "theme.bar.margin_sides" = "${toString gaps-in}px";
      ...
      "theme.bar.menus.opacity" = opacity * 100;
      ...
      "theme.bar.menus.progressbar.radius" = "0.6em";
      "theme.bar.menus.slider.progress_radius" = "0.6em";
      "theme.bar.menus.slider.slider_radius" = "0.6em";
      "theme.bar.menus.switch.radius" = "0.6em";
      "theme.bar.menus.switch.slider_radius" = "0.6em";
